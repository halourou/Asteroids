(function () {
  ...
  Sprite.prototype.render = function (ctx, pos, angle) {
    this.rotateSprite(ctx, pos[0], pos[1], angle);
  };

  Sprite.prototype.rotateSprite = function (context, posX, posY, angle) {
    var toRadian = Math.PI/180;
    context.save();
    context.translate(posX, posY);
    context.rotate(angle * toRadian)

    context.drawImage(this.img, (this.frameIdx * this.width/this.numFrames), 0,

(function () {
  ...
  GameView.prototype.handleClick = function () {
    this.$container.find("button.start").click(function (e) {
      ...
      // if (this.$container.find(".game-over").hasClass("yay")) {
      //   this.$container.find(".game-over").removeClass("yay");
      // } else if (this.$container.find(".game-over").hasClass("nay")) {
      //   this.$container.find(".game-over").removeClass("nay");
      // }

(function () {
  ...
  Game.prototype.addPoofs = function (pos) {
    for (var i = 0; i < 4; i++) {
      this.add(new windw.Asteroids.Poof({pos: pos, game: this}))
    }
  }
  ...
  Game.prototype.add = function (obj) {
    ...
    } else if (obj instanceof window.Asteroids.Poof) {
      this.poofs.push(obj);
    };
  };
  ...
  Game.prototype.remove = function(obj) {
    ...
    } else if (obj instanceof windw.Asteroids.Poof) {
      this.poofs.splice(this.poofs.indexOf(obj), 1);
    };
  };

  Game.prototype.allObjects = function() {
    var allObjects = this.fishies.slice();
    allObjects.concat(this.poofs)
